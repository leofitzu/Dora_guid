    ...
    def __getitem__(self, index):
        ...
        if name=="cat":
            if self.without_painting:
                new_prompt=self.attribute_prompt+' animal of '+str(file_name)
            else:
                new_prompt=self.attribute_prompt+' animal painting of '+str(file_name)# + " by style_00"
        elif name=="flower":
            if self.without_painting:
                new_prompt=self.attribute_prompt+' plant of '+str(file_name)
            else:
                new_prompt=self.attribute_prompt+' plant painting of '+str(file_name)# + " by style_00"
        elif name=="sword":
            if self.without_painting:
                new_prompt=self.attribute_prompt+' object of '+str(file_name)
            else:
                new_prompt=self.attribute_prompt+' object painting of '+str(file_name)# + " by style_00"
